---
title: Visiting Basics
slug: visiting-basics
...
**State Prisons**  
Run by each state's corrections department. These hold people serving sentences longer than one year. Visiting policies vary significantly by state. **Check your state's specific page for details.**
:::

:::callout{variant="info"}
**Federal Prisons**  
Run by the Federal Bureau of Prisons (BOP). These hold people convicted of federal crimes. Federal prisons tend to have standardized visiting policies across locations, though individual facilities may have variations.
:::

:::callout{variant="info"}
**County Jails**  
Hold people awaiting trial, serving short sentences, or awaiting transfer. Run by county sheriffs' departments. Visiting policies vary widely—call the specific jail to ask about rules.
:::

:::callout{variant="tip"}
**How to find out where someone is incarcerated:** Federal inmates can be found using the [BOP Inmate Locator](https://www.bop.gov/mobile/find_inmate/). For state prisons, each state has its own inmate search system—your state's Department of Corrections website will have a link.
:::
...
:::reality-check{title="Technical considerations"}
Video visit systems often experience technical issues. Internet delays, dropped calls, and frozen screens are common. Video visits do not provide the same in-person interaction as facility visits.
:::
...
:::steps
1. **Find the facility's visiting rules.** Search your state's DOC website (if state prison) or call the facility directly (if county jail or federal). You need to know: approved visiting hours, what forms to fill out, and what ID you need to bring.
1. **Fill out a visitor application.** This is usually a one-time form with basic information: your name, address, date of birth, relationship to the incarcerated person, and criminal history. Some facilities require this in advance; others process it when you arrive. The incarcerated person may need to request that you be approved on their end.
1. **Pass a background check.** Facilities run background checks on visitors. They're looking for serious criminal history or restraining orders. Most people pass without issue. Denials typically occur only if you have a felony conviction or are explicitly prohibited from contact with the incarcerated person.
1. **Receive approval.** You'll be notified (usually by phone, mail, or email) when you're approved. At some facilities, you just show up during visiting hours with ID; at others, you may need to schedule visits in advance.
:::

:::callout{variant="warning"}
**Timeline varies:** Some facilities approve visitors same-day. Others take 1-2 weeks. Call ahead to ask how long approval typically takes.
:::

:::reality-check{title="Visitor approval process"}
Visitor denials are typically based on criminal history, restraining orders, or facility disputes. If denied, request the reason in writing and ask about the appeal process. Most facilities have formal appeal procedures, though processing can take several weeks to months.
:::
...
:::key-info{title="General dress code guidelines"}
-   **Avoid bright or bold colors.** Some facilities restrict orange, blue, orange/white, or specific color combinations that match inmate uniforms. This prevents confusion and escape attempts.
-   **Keep it modest.** No low-cut tops, no visible undergarments, no sheer clothing. Bra straps should be covered.
-   **Wear pants or a skirt.** Shorts are often prohibited, though some facilities allow them if knee-length or longer.
-   **Close-toed shoes required.** Most facilities require shoes (athletic or regular, not sandals or flip-flops).
-   **Minimal jewelry.** Some facilities limit jewelry, especially large pieces or multiple rings.
-   **Avoid patterns.** Striped or checked patterns are sometimes prohibited.
:::
...
:::reality-check{title="Dress code enforcement"}
Dress code enforcement varies between facilities and staff members. Some facilities enforce dress codes strictly while others enforce more selectively. Dress conservatively to avoid being denied entry.
:::
...
:::key-info{title="Typically PROHIBITED (varies by facility)"}
-   Cell phones and recording devices
-   Weapons of any kind
-   Alcohol or illegal drugs
-   Bags, purses, or large containers (small clear bags may be allowed)
-   Jackets or coats (depends on facility)
-   Anything with chains, hooks, or metal
...
**Checking visiting hours:** Most state DOC websites have a facility finder where you can look up current visiting hours. For federal prisons, check the [BOP website](https://www.bop.gov/). For county jails, call directly—hours are often posted online but may change frequently.

:::callout{variant="tip"}
**Call the facility before traveling:** Facilities sometimes close for unexpected security issues or staff shortages. A short confirmation call can prevent a wasted long trip.
:::
...
:::reality-check{title="Visiting room environment"}
Visiting rooms typically have hard seating, variable lighting, and inconsistent temperature control. The environment with multiple visits happening simultaneously creates background noise that can affect conversation quality.
:::
