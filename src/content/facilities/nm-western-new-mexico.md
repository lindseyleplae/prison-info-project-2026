...
summary: "A New Mexico Corrections Department campus in Grants that holds both a women's facility — including the state's women's Reception and Diagnostic Center — and a medium-custody men's facility."
city: "Grants"
county: "Cibola"
address: "2111 Lobo Canyon Road, Grants, NM 87020"
securityLevel: "Medium custody (men and women)"
...
Western New Mexico Correctional Facility is a single campus in Grants with two separate sides: a women's facility — which also holds the state's women's Reception and Diagnostic Center — and a medium-custody men's facility. The two sides have their own addresses, phone numbers, and arrangements, so confirm which side holds the person before traveling or sending anything. Check the person's current facility on the [NMCD Offender Search](https://www.cd.nm.gov/offender-search/) first — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a Securus processing center for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Grants, Cibola County, in northwestern New Mexico
- **Population:** Men and women, medium custody (a women's side and a men's side on one campus)
- **Notable:** Holds the women's Reception and Diagnostic Center for the state; the men's side returned to state operation in November 2021
- **Visitation:** By approved list, arranged with the facility; the women's and men's sides may differ
:::
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the inmate's approved visitor list. The incarcerated person initiates the list by adding visitors; setup is handled by the facility. Visitors must also be on the approved list before depositing money.
- **Scheduling:** Arranged with the facility — New Mexico has no statewide online visit scheduler. Because the campus has a separate women's side and men's side, confirm scheduling, days, and hours with the side that holds the person.
- **Days and hours:** Set by the facility and not published on a single statewide page; confirm the current schedule directly. Whether a visit is contact or non-contact depends on the person's custody level and housing.
- **Video visits:** Available through the Securus tablet system; visitors must be approved by NMCD first.
- **Women's side line:** (505) 876-8333
- **Men's side line:** (505) 287-2941
:::
