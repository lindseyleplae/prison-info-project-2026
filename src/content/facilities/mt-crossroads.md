...
system: "MT DOC"
population: men
summary: "A privately operated secure prison for men in Shelby, run by CoreCivic under contract with the Montana Department of Corrections — the state's only in-state private prison."
city: "Shelby"
county: "Toole"
address: "50 Crossroads Drive, Shelby, MT 59474"
securityLevel: "Secure (men)"
...
visiting:
  ...
  scheduling: "Crossroads is a contracted CoreCivic facility that sets its own visiting process; every visitor must still be approved through Montana DOC (login.mt.gov). Confirm scheduling and rules directly with the facility."
  contactVisits: true
links:
...
Crossroads Correctional Center is a privately operated secure prison for men, run by CoreCivic under contract with the Montana Department of Corrections. Confirm the person's current facility on [ConWeb, Montana's offender locator](https://app.mt.gov/conweb/), before traveling or sending anything — people are transferred between facilities. Because Crossroads is a contracted facility, it runs its own mail, phone, and visiting arrangements, which differ from Montana's statewide systems. Confirm the current rules directly with the facility before you send mail, schedule a visit, or set up calls.
:::

:::key-info
- **Location:** Shelby, Toole County, in north-central Montana near the Canadian border
- **Population:** Men, secure custody (medium/close)
- **Notable:** Operated by CoreCivic under contract with Montana DOC — the state's only in-state private prison, with capacity for about 750 people
- **Visitation:** Set by the facility; every visitor must still be approved through Montana DOC first
:::
...
:::key-info
- **Approval first:** Every visitor must be approved through Montana DOC before visiting. Create an account at [login.mt.gov](https://login.mt.gov/) and complete the online visitation application; background review can take up to about 90 days, though it is often faster.
- **Scheduling:** Crossroads sets its own visiting process as a contracted facility. After a visitor is approved, confirm the days, hours, scheduling method, and visitor limits directly with the facility — these are not the same as the statewide schedules used at the state-run prisons.
...
- [Visiting](/states/montana/guides/visiting/) — Montana's approved-visitor
  application, scheduling, and the rules that apply at every facility.
- [Mail](/states/montana/guides/mail/) — how Montana scans incoming personal mail
  off-site and how to address letters, legal mail, books, and money.
- [Phone & Video](/states/montana/guides/phone-video/) — calls, tablet messaging,
  and video visits through ICSolutions and GettingOut.
- [Money](/states/montana/guides/money/) — how to put money on an account and the
  vendors Montana uses.
- [Medical](/states/montana/guides/medical/) — how health care works in Montana's
  prisons and how to raise a medical concern.
- [Transfers](/states/montana/guides/transfers/) — how people enter the system,
  reception and assessment, and how transfers between facilities work.
