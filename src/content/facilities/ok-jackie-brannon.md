...
system: "Oklahoma DOC"
population: men
summary: "A minimum-security state prison for men on the grounds of the Oklahoma State Penitentiary in McAlester, Oklahoma — a standalone facility since 1985."
...
Jackie Brannon Minimum Unit is a minimum-security prison for men. It sits on the same McAlester grounds as the Oklahoma State Penitentiary (OSP) but is a separate minimum-security facility — confirm which McAlester facility the person is in on the [Oklahoma DOC offender lookup](https://okoffender.doc.ok.gov/) before traveling or sending anything, because the two are run as one operation and people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a Securus Digital Mail Center for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** McAlester, Pittsburg County, in southeastern Oklahoma
- **Population:** Men, minimum custody
- **Notable:** A minimum-security facility on the grounds of the Oklahoma State Penitentiary; a standalone institution since 1985
