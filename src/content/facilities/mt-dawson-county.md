...
system: "MT DOC"
population: men
summary: "A county-operated regional prison in Glendive that holds Montana Department of Corrections men under contract."
city: "Glendive"
county: "Dawson"
address: "440 Colorado Blvd, Glendive, MT 59330"
securityLevel: "Secure (men)"
facilityType: "Regional Prison (county-operated, contracted)"
...
visiting:
  ...
  scheduling: "Dawson County is a contracted county-run facility that sets its own visiting process; every visitor must still be approved through Montana DOC (login.mt.gov). Confirm scheduling and rules directly with the facility."
  contactVisits: true
links:
...
Confirm the person's current facility on the [Montana ConWeb locator](https://app.mt.gov/conweb/) before traveling or sending anything — people are transferred without family notification. Dawson County Correctional Facility is a county-operated prison that holds Montana DOC men under contract, and it runs its own mail, phone, and visiting arrangements, which differ from the statewide Montana DOC systems. Confirm the current details directly with the facility before relying on them.
:::

:::key-info
- **Location:** Glendive, Dawson County, in eastern Montana
- **Population:** Men, Montana DOC custody held under contract
- **Notable:** A county-operated regional prison of about 140 beds — not a state-run institution; it sets its own mail, phone, and visiting procedures
- **Visitation:** Set by the facility, after a visitor is approved through Montana DOC
:::
...
:::key-info
- **Approved list first:** Every visitor must be approved through Montana DOC before visiting. Create an account at login.mt.gov and complete the online visitation application; background review can take several weeks. The facility coordinates the local arrangements once a visitor is approved.
- **Scheduling:** Dawson County sets its own visiting schedule and process. There is no statewide online scheduler for this facility — call to confirm current days, hours, whether visits are contact or non-contact, and how to schedule.
- **Identification:** A valid government photo ID is generally required, and minors are accompanied by an adult. Confirm the current ID and dress requirements with the facility before arriving.
- **Main line:** 406-377-7600
:::
