...
system: "MN DOC"
population: men
summary: "A large close-security state prison for men, physically located in Bayport, Washington County, Minnesota — one of the oldest prisons in the state, opened in 1914. Despite its name, it is not in the city of Stillwater."
...
Minnesota Correctional Facility – Stillwater is a close-security prison for men. Despite its name, it is physically located in the city of Bayport, not the city of Stillwater — the two are neighboring cities in Washington County, and visitors who set out for the city of Stillwater will not reach the prison. Confirm the person's current facility on the [Minnesota DOC Offender Locator](https://coms.doc.state.mn.us/PublicViewer/Home/Index) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a vendor, TextBehind, for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Bayport, Washington County, in the east-central Minnesota Twin Cities metro area (not the city of Stillwater)
- **Population:** Men, close custody
- **Notable:** A large close-security men's prison and one of the oldest in Minnesota, opened in 1914
- **Visitation:** By approved list; the application is mailed to the MN DOC central intake at MCF-Rush City
:::
...
:::key-info
- **Approved list first:** Every visitor must be approved before a visit. In Minnesota, the visiting application is mailed to the DOC's central intake at MCF-Rush City for processing, not to this facility.
- **Scheduling:** Confirm days, hours, and how to schedule directly with the facility before traveling, because the schedule is set at the facility level.
- **Days and hours:** Set by the facility. Confirm the current visiting schedule before arriving.
- **Video visits:** Available through JPay Video Connect, in addition to in-person visits.
- **Main line:** 651-779-2700
:::
...
> MCF-Stillwater, Minnesota (do not abbreviate Minnesota)
> P.O. Box 247
> Phoenix, MD 21131
