...
system: "KY DOC"
population: men
summary: "A medium-security state prison for men in Wheelwright, Kentucky — opened in December 2020 in the former Otter Creek Correctional Center building, run by the Kentucky DOC in a building leased from CoreCivic."
city: "Wheelwright"
county: "Floyd"
...
providers:
  phone: "Securus"
visiting:
  days: "Set by the facility; visits are scheduled about a week in advance"
  hours: "Confirm the facility's current visiting schedule"
  scheduling: "Every visitor must be on the inmate's approved visiting list first; visits are scheduled with the facility about a week in advance (there is no statewide scheduler). Confirm with the facility."
  contactVisits: true
links:
...
The Southeast State Correctional Complex is a medium-security prison for men in Wheelwright, Floyd County. Confirm the person's current facility on the [Kentucky Offender Online Lookup](https://kool.corrections.ky.gov/) before traveling or sending anything — people are transferred without family notification. Incoming personal mail goes directly to the facility (see [Mail](#mail)). Note: the Southeast State Correctional Complex is state-operated, run by the Kentucky DOC; it is not the same as the Lee Adjustment Center in Beattyville, which is a privately operated CoreCivic prison. Because the Southeast State Correctional Complex is state-run, it follows the statewide Kentucky DOC systems for visiting, mail, and accounts.
:::

:::key-info
- **Location:** Wheelwright, Floyd County, in eastern Kentucky
- **Population:** Men, medium custody
- **Notable:** Opened in December 2020 in the former Otter Creek Correctional Center building; state-operated by the Kentucky DOC, though the building is leased from CoreCivic
- **Visitation:** By approved list; visits are scheduled with the facility about a week in advance
:::
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the inmate's approved visiting list. The inmate requests the people to be added, and adult visitors are checked before approval.
- **Scheduling:** Visits are scheduled with the facility about a week in advance. There is no statewide online scheduler, so families arrange visits directly with the prison.
- **Days and hours:** Visiting days and hours are set by the facility. Confirm the current schedule with the prison before traveling. Whether a visit is contact or non-contact depends on the person's security level and housing unit.
- **Main line:** 606-452-6300
:::
