...
system: "NMCD"
population: men
summary: "The state's maximum-security prison for men in Santa Fe, New Mexico — holding the highest custody classification (Levels 2 and 4, plus a Special Management Unit)."
...
The Penitentiary of New Mexico is a maximum-security prison for men. Confirm the person's current facility on the [NMCD Offender Search](https://www.cd.nm.gov/offender-search/) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a Securus processing center in Seminole, Florida, for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Santa Fe, Santa Fe County, in north-central New Mexico
- **Population:** Men, maximum custody (Levels 2 and 4, plus a Special Management Unit)
- **Notable:** The state's maximum-security prison, holding the highest custody classification; site of a 1980 riot
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the inmate's approved visitor list. The incarcerated person initiates the request to add visitors; approval is handled by the facility.
- **Scheduling:** Arranged with the facility. There is no statewide online scheduler in New Mexico — each prison handles its own scheduling and approvals.
- **Days and hours:** Set by the facility and varying by custody level. Confirm the current visiting schedule, and whether a visit is contact or non-contact, with the facility before traveling.
- **Main line:** (505) 827-8201
:::
