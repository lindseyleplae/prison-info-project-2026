...
summary: "Kauai's jail, in Lihue, a small facility holding pretrial and sentenced men and women, with tablet-based phone and video visits."
aliases:
  - KCCC
city: Lihue
county: Kauai
...
Kauai Community Correctional Center is a jail that holds both men and women and both pretrial and sentenced people. Custody status and housing can change, and people are sometimes moved between Hawaii facilities, so confirm the person's current location on [VINELink](https://www.vinelink.com/) before traveling or sending anything. The facility is on Kauai; reaching it from Oahu or another island requires inter-island air travel.
:::

:::key-info
- **Location:** Lihue, Kauai
- **Population:** Men and women, mixed custody; both pretrial and sentenced
- **Notable:** Kauai's jail; reachable from other islands mainly by air, with tablet-based video visits as the remote option
...
- **Video visits:** Video visits are available through the facility's tablets, run by GTL (ViaPath). This is the main remote option for families who cannot travel to Kauai.
