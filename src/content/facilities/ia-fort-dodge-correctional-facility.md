...
system: "Iowa DOC"
population: men
summary: "A medium-security men's prison in Fort Dodge with a structured reentry and transition program."
aliases:
  - FDCF
city: Fort Dodge
county: Webster
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be approved. The approved visitor list is established through the Iowa DOC Centralized Visiting Authority and stays valid across transfers.
- **Scheduling:** After approval, visits and video calls are scheduled through the Ameelio Connect app. Confirm the current process with the facility before a first visit.
