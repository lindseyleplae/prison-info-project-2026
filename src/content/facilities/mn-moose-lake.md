...
system: "MN DOC"
population: men
summary: "A medium-security state prison for men in Moose Lake, Minnesota, holding incarcerated people in custody levels 1 through 3."
...
Minnesota Correctional Facility – Moose Lake is a medium-security prison for men. Confirm the person's current facility on the [MN DOC Offender Locator](https://coms.doc.state.mn.us/PublicViewer/Home/Index) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a private vendor, TextBehind, for scanning (see [Mail](#mail)). Note that a separate facility, the Minnesota Sex Offender Program (MSOP), is also located in Moose Lake and shares the campus, but it is a civil-commitment treatment program run by the Department of Human Services — it is not a prison and is not run by the Department of Corrections.
:::

:::key-info
- **Location:** Moose Lake, Carlton County, in east-central Minnesota
- **Population:** Men, medium custody (levels 1 through 3)
- **Notable:** A separate program, the Minnesota Sex Offender Program (MSOP), is also in Moose Lake but is run by the Department of Human Services, not the Department of Corrections
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the person's approved visitor list. Visiting applications are mailed to the MN DOC central intake at MCF-Rush City for processing.
- **Scheduling:** Confirm the current process with the facility. Video visits are available through JPay Video Connect.
- **Days and hours:** Set by the facility. Confirm the facility's current visiting schedule before traveling.
- **Main line:** 218-485-5000
:::
...
> MCF-Moose Lake, Minnesota (do not abbreviate Minnesota)
> P.O. Box 247
> Phoenix, MD 21131
