...
system: "NCDAC"
population: men
summary: "A close- and minimum-security state prison for men in Morganton, in the western North Carolina foothills, housing many young adults."
...
Foothills Correctional Institution is a close- and minimum-security prison for men. Confirm the person's current facility on the [NCDAC offender locator](https://webapps.doc.state.nc.us/opi/offendersearch.do?method=view) before traveling. Personal mail goes to the off-site TextBehind vendor — see [Mail](#mail).
:::

:::key-info
- **Security level:** Close and minimum security (men)
...
Foothills Correctional Institution is a close- and minimum-security prison for men in Morganton, Burke County, in the western North Carolina foothills. The facility is operated by the North Carolina Department of Adult Correction (NCDAC).

According to the NCDAC, the main facility holds close-custody men, while minimum-custody men are housed in separate dormitories on the same campus.
...
## What Makes Foothills Different

According to the NCDAC, the close-custody portion of Foothills houses men ages 18 to 25 — a young-adult population in close custody. Minimum-custody men occupy separate dormitories on the same campus. The current custody assignment and housing for a particular person can be confirmed through the prison or on the [NCDAC offender locator](https://webapps.doc.state.nc.us/opi/offendersearch.do?method=view).

## Visiting

The statewide NCDAC rules above — the approved visitor list, the dress code, ID, and item limits — apply at Foothills Correctional Institution. The facility's own arrangements:
...
- **Scheduling:** Visits are by appointment only. North Carolina has no statewide online scheduler — call or email Foothills Correctional Institution to schedule, and confirm visitation status the day before.
...
Foothills Correctional Institution is at 5150 Western Ave., Morganton, NC 28655, in Burke County in the western North Carolina foothills. Morganton lies along Interstate 40 between Hickory to the east and Asheville to the west. There is no public-transit service to the facility; visitors generally arrive by private vehicle. Confirm visiting days and hours with the facility before traveling.

## Nearby Services

Morganton is the seat of Burke County. The nearest full-service hospital emergency room is in Morganton, with additional hospitals in the Hickory area to the east along Interstate 40. Lodging, fuel, and restaurants are available in Morganton and in the Hickory area.
