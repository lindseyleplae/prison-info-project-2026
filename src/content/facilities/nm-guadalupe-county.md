...
system: "NMCD"
population: men
summary: "A medium-security state prison for men in Santa Rosa, New Mexico — built in 1997 and state-operated since 2021; despite its name, it is a state prison, not a county jail, and it houses male parole violators."
...
Guadalupe County Correctional Facility is a state prison for men, not a county jail — despite the "County" in its name, it is operated by the New Mexico Corrections Department. Confirm the person's current facility on the [NMCD Offender Search](https://www.cd.nm.gov/offender-search/) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a Securus processing center in Seminole, Florida, for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Santa Rosa, Guadalupe County, in east-central New Mexico
- **Population:** Men, medium custody (Level 3)
- **Notable:** Built in 1997; state-operated since 2021. The building is owned by the GEO Group and leased, but the prison itself is run by the state. It houses male parole violators.
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the inmate's approved visitor list. The incarcerated person initiates the request to add a visitor; approval is handled by the facility.
- **Scheduling:** Visits are arranged with the facility — there is no statewide online scheduler. Confirm the current process and contact for scheduling and approvals with the facility.
- **Days and hours:** Set by the facility. Confirm the current visiting days and hours before traveling. Whether a visit is contact or non-contact depends on the person's custody level and housing unit.
- **Main line:** (575) 472-1002
:::
