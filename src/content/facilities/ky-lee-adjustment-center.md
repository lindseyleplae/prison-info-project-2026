...
system: "KY DOC"
population: men
summary: "A privately operated medium-security prison for men in Beattyville, run by CoreCivic under contract with the Kentucky Department of Corrections — the only currently active private prison holding Kentucky state inmates, with reentry, vocational, and substance-use programming."
city: "Beattyville"
county: "Lee"
address: "168 Lee Adjustment Center Drive, Beattyville, KY 41311"
securityLevel: "Medium security (men)"
facilityType: "Private Prison (CoreCivic, contracted)"
...
visiting:
  ...
  scheduling: "Lee Adjustment Center is a contracted CoreCivic facility that sets its own visiting process; every visitor must still be on the inmate's approved list. Confirm scheduling and rules directly with the facility."
  contactVisits: true
links:
...
Lee Adjustment Center is a privately operated prison run by CoreCivic under contract with the Kentucky Department of Corrections — not a state-run institution. Confirm the person's current facility on [KOOL, Kentucky's Offender Online Lookup](https://kool.corrections.ky.gov/), before traveling or sending anything, because people are transferred between facilities. Because Lee is a contracted facility, it runs its own mail, phone, and visiting arrangements, which differ from the statewide KY DOC systems. Confirm the current rules directly with the facility before you send mail, schedule a visit, or set up calls. Note that Lee Adjustment Center, in Beattyville, is a different facility from the state-operated Southeast State Correctional Complex in Wheelwright, which the state runs as a public prison.
:::

:::key-info
- **Location:** Beattyville, Lee County, in eastern Kentucky
- **Population:** Men, medium security
- **Notable:** Operated by CoreCivic under contract with the Kentucky DOC — an 866-bed prison and the only currently active private prison holding Kentucky state inmates, with reentry, vocational, and substance-use programming
- **Visitation:** Set by the facility; every visitor must still be on the inmate's approved list
:::
...
:::key-info
- **Approved list first:** Every visitor must be on the inmate's approved visitor list before visiting. In Kentucky, the incarcerated person requests visitors, and adult visitors generally need valid government photo ID; minors must be accompanied by a parent or legal guardian.
- **Scheduling:** Lee sets its own visiting process as a contracted facility. After a visitor is approved, confirm the days, hours, scheduling method, and visitor limits directly with the facility — these are not the same as the schedules used at the state-run prisons.
- **Contact or non-contact:** Whether a visit is contact or non-contact depends on the person's custody level and status; confirm with the facility.
- **Main line:** 606-464-2866
:::
