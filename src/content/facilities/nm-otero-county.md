...
system: "NMCD"
population: men
summary: "A privately operated prison for men in Chaparral, New Mexico — run by Management & Training Corporation under contract with the New Mexico Corrections Department, and the only private prison still holding New Mexico state inmates."
city: "Chaparral"
county: "Otero"
address: "10 McGregor Range Road, Chaparral, NM 88081"
securityLevel: "Medium and close security (men)"
facilityType: "Private Prison (MTC, contracted)"
...
The Otero County Prison Facility is a prison for men operated under contract by Management & Training Corporation (MTC) for the New Mexico Corrections Department. Because MTC runs the facility, its visiting schedule and some day-to-day arrangements are set locally — confirm the current details directly with the facility before traveling. This prison is distinct from the federal Otero County Processing Center, an immigration detention site also located in Chaparral; do not confuse the two. Confirm the person's current facility on the [NMCD Offender Search](https://www.cd.nm.gov/offender-search/) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a Securus processing center in Florida for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Chaparral, Otero County, in southern New Mexico near the Texas state line
- **Population:** Men, medium and close custody, with a Restrictive Housing Unit
- **Notable:** The only privately operated prison still holding New Mexico state inmates; operated by MTC and home to a Sex Offender Treatment Program
- **Visitation:** By approved list; schedule and arrangements are set by the facility
:::
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the inmate's approved visitor list. Setup is handled through the facility; the incarcerated person initiates the request to add a visitor.
- **Scheduling:** Because the facility is operated under contract by MTC, its visiting schedule and arrangements are set locally. There is no statewide online scheduler. Confirm the current visiting days, hours, and procedures directly with the facility.
- **Contact vs. non-contact:** Whether a visit is contact or non-contact depends on the person's custody level and housing unit. People in the Restrictive Housing Unit are subject to different visiting rules.
- **Main line:** (575) 824-4884
:::
