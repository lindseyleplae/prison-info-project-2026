...
system: "NMCD"
population: men
summary: "A multi-level state prison for men in Las Cruces, New Mexico, holding custody Levels 2 through 4 plus a Restrictive Housing Unit."
...
Southern New Mexico Correctional Facility holds men across several custody levels. Confirm the person's current facility on the [NMCD Offender Search](https://www.cd.nm.gov/offender-search/) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to a Securus processing center in Seminole, Florida, for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Las Cruces, Doña Ana County, in southern New Mexico
- **Population:** Men, custody Levels 2 through 4
- **Notable:** A southern-region men's prison with multiple custody levels and a Restrictive Housing Unit; operational since 1983
- **Visitation:** By approved list, arranged with the facility; no statewide scheduler
:::
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the inmate's approved visitor list. The incarcerated person initiates the request to add a visitor; approval is handled by NMCD before a first visit.
- **Scheduling:** Arranged with the facility — New Mexico has no statewide online visit scheduler. Confirm the current process, including whether visits must be booked in advance, with the facility.
- **Days and hours:** Set by the facility and can vary by custody level. Confirm the current visiting schedule before traveling.
- **Main line:** (575) 523-3200
:::
