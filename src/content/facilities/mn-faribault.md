...
system: "MN DOC"
population: men
summary: "A medium-security state prison for men in Faribault, Minnesota — the largest prison in the Minnesota DOC by population, holding a general-population men's count at custody Levels 1–3."
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be approved. Visiting applications are mailed to the Minnesota DOC central intake at MCF-Rush City, not to MCF-Faribault directly.
- **Scheduling:** Confirm the current process with the facility before a first visit; the days, hours, and any scheduling steps are set by the facility.
...
> MCF-Faribault, Minnesota (do not abbreviate Minnesota)
> P.O. Box 247
> Phoenix, MD 21131
