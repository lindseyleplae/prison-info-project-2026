...
system: "MN DOC"
population: men
summary: "Minnesota's only maximum-security state prison (Level 5) for men, in Oak Park Heights, Washington County — it holds the highest-security population in the state system."
aliases: ["MCF-Oak Park Heights", "Oak Park Heights"]
city: "Oak Park Heights"
county: "Washington"
address: "5329 Osgood Avenue North, Stillwater, MN 55082"
securityLevel: "Maximum security (Level 5, men)"
...
Minnesota Correctional Facility – Oak Park Heights is the state's only maximum-security prison and holds the highest-security population in the Minnesota DOC system. Confirm the person's current facility on the [Minnesota DOC Offender Locator](https://coms.doc.state.mn.us/PublicViewer/Home/Index) before traveling or sending anything — people are transferred between facilities. Personal mail does not go to the prison; it goes off-site to the vendor TextBehind for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Oak Park Heights, Washington County, in eastern Minnesota near the St. Croix River
- **Population:** Men, maximum custody (Level 5)
- **Notable:** Minnesota's only maximum-security facility, holding the state's highest-security population
- **Visitation:** By approved list; days, hours, and scheduling are set by the facility, and video visits are available through JPay Video Connect
:::
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be on the person's approved visitor list. Visiting applications are mailed to the Minnesota DOC central intake at MCF-Rush City for processing.
- **Scheduling:** Confirm the current scheduling process with the facility before a first visit, because the maximum-security setting affects how visits are arranged.
- **Days and hours:** Set by the facility. Confirm the current visiting schedule directly with MCF-Oak Park Heights, as days and hours can change.
- **Video visits:** Available through JPay Video Connect, in addition to in-person visiting.
- **Main line:** 651-779-1400
:::
...
> MCF-Oak Park Heights, Minnesota (do not abbreviate Minnesota)
> P.O. Box 247
> Phoenix, MD 21131
