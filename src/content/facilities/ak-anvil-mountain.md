...
summary: "A mixed-custody Alaska DOC correctional center in Nome that holds men and women — both pretrial and sentenced — for the Bering Strait and Northwest Alaska region."
city: "Nome"
county: "Nome Census Area"
address: "1810 Center Creek Rd., Nome, AK 99762"
securityLevel: "Mixed custody (men and women)"
...
visiting:
  ...
  scheduling: "Every visitor must be on the prisoner's approved visitor list (with a photo ID); there is no statewide scheduler — confirm days, hours, and whether an appointment is needed with the facility."
  contactVisits: true
links:
...
Anvil Mountain Correctional Center holds both men and women, and both pretrial and sentenced people. Because Alaska runs a unified system, where a person is held can change as a case moves or as classification changes — confirm the person's current facility on [VINELink](https://www.vinelink.com/) before traveling or sending anything. Nome is off the road system and is reached mainly by plane, so confirm visiting days and hours with the facility before booking travel. Personal mail goes directly to the facility, not to an off-site vendor (see [Mail](#mail)).
:::

:::key-info
- **Location:** Nome, in the Nome Census Area, on the Seward Peninsula in northwest Alaska
- **Population:** Men and women, mixed custody
- **Notable:** The regional facility for the Bering Strait and Northwest Alaska region; holds both pretrial and sentenced people in Alaska's unified jail-and-prison system
- **Getting there:** Nome is off the road system — reachable mainly by plane
:::
...
:::key-info
- **Approved list first:** After the first 24 hours in custody, every visitor must be on the prisoner's approved visitor list and must show a driver's license or other government-issued photo ID. A person can normally be on only one prisoner's list (an immediate family member is an exception). Visitors and their belongings are searched.
- **First 24 hours:** During the first 24 hours after a person is booked on new charges, family and friends may visit without being on an approved list — just bring valid government photo ID to the front desk.
- **Scheduling:** There is no statewide online scheduler. Visiting hours are set per facility — confirm the current days, hours, and whether an appointment is required by calling Anvil Mountain or checking its page on the [AK DOC institutions site](https://doc.alaska.gov/institutions). Most visits run about one hour.
- **Contact vs. non-contact:** Alaska uses Secure Visitation (limited or no physical contact) and Contact Visitation (a brief hug allowed only at the start and end). Which one applies depends on the person's custody level and housing.
- **Main line:** 907-443-2241
:::
...
> [Prisoner's full name and number]
...
- [Visiting an Alaska prison](/states/alaska/guides/visiting/) — Approved visitor lists, the per-facility scheduling and appointment norms, dress code, ID, and what to expect at remote facilities.
- [Sending mail in Alaska](/states/alaska/guides/mail/) — How to address personal mail to the facility, the white-envelope rules, and how to order books, publications, and packages from approved vendors.
- [Phone calls and video in Alaska](/states/alaska/guides/phone-video/) — Setting up a Securus AdvanceConnect account, how calls are billed, free monthly calls, and the rules on three-way and forwarded calls.
- [Sending money in Alaska](/states/alaska/guides/money/) — How to put money on an Offender Trust Account in person or by mail, who is allowed to deposit, accepted forms, and the monthly limit.
- [Medical care in Alaska prisons](/states/alaska/guides/medical/) — How health, dental, and mental-health care work in DOC facilities, co-pay amounts, and how to request care.
- [Intake, classification, and transfers in Alaska](/states/alaska/guides/transfers/) — The booking process, the four custody levels, and how people are housed in Alaska's unified jail-and-prison system.
