...
system: "AK DOC"
population: men
summary: "Alaska's only maximum-security prison, in Seward — a state correctional center for men holding the state's highest-custody men, both pretrial and sentenced."
...
providers:
  phone: "Securus"
visiting:
  days: "Set by the facility; visits are commonly by appointment"
  hours: "Confirm the facility's current visiting schedule"
  scheduling: "Every visitor must be on the prisoner's approved visitor list (with a photo ID). There is no statewide scheduler, and Spring Creek commonly schedules visits by appointment — confirm days and hours with the facility."
  contactVisits: true
links:
...
Spring Creek Correctional Center is Alaska's only maximum-security prison and holds the state's highest-custody men. Because Alaska runs a unified jail-and-prison system, the facility holds both people awaiting trial and people serving sentences. Confirm the person's current facility on [VINELink](https://www.vinelink.com/) (select Alaska) before traveling or sending anything — people are transferred between facilities without family notification. Personal mail goes directly to the facility in Seward, not to an off-site vendor (see [Mail](#mail)).
:::

:::key-info
- **Location:** Seward, Kenai Peninsula Borough, on the southern coast about 125 miles south of Anchorage
- **Population:** Men, maximum custody; both pretrial and sentenced
- **Notable:** Alaska's only maximum-security prison — it houses the state's highest-custody men
- **Visitation:** By the prisoner's approved visitor list; commonly scheduled by appointment with the facility
:::
...
:::key-info
- **Approved list first:** After the first 24 hours of custody, every visitor must be on the prisoner's approved visitor list and must show a driver's license or government-issued photo ID. Visitors and their belongings are searched before a visit.
- **Scheduling:** There is no statewide online scheduler. Spring Creek commonly schedules visits by appointment and arranges them in advance, so confirm the current process with the facility before traveling.
- **Days and hours:** Set by the facility and posted per institution. Confirm the current visiting schedule with the prison, because hours and the appointment requirement can change. Whether a visit is contact or non-contact depends on the person's custody level and housing unit.
- **Main line:** 907-224-8200
:::
