...
system: "MN DOC"
population: men
summary: "A minimum-security (Level 1) state prison for men in Willow River, Minnesota — home to the Challenge Incarceration Program, the state's intensive boot-camp program for eligible men."
...
Minnesota Correctional Facility – Willow River is a minimum-security prison for men. Confirm the person's current facility on the [Minnesota DOC Offender Locator](https://coms.doc.state.mn.us/PublicViewer/Home/Index) before traveling or sending anything — people are transferred between facilities. Personal mail does not go to the prison; since November 1, 2024, it goes off-site to a vendor, TextBehind, for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Willow River, Pine County, in east-central Minnesota
- **Population:** Men, minimum custody (Level 1)
- **Notable:** Operates the Challenge Incarceration Program (CIP), Minnesota's intensive boot-camp program; the men's CIP runs here and at MCF-Togo
- **Visitation:** By approved list; confirm days, hours, and scheduling with the facility
:::
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be approved. Visiting applications are mailed to the Minnesota DOC's central intake at MCF-Rush City; the person inside can confirm what the facility needs and how long approval takes.
- **Scheduling:** Confirm the current days, hours, and any scheduling steps with the facility before traveling, as the routine at a Challenge Incarceration Program site can differ from a general-population prison.
- **Video visits:** Available through JPay Video Connect, separate from in-person visits.
- **Main line:** 218-372-3101
:::
...
> MCF-Willow River, Minnesota (do not abbreviate Minnesota)
> P.O. Box 247
> Phoenix, MD 21131
