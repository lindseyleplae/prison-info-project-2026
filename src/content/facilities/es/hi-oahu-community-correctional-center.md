...
Hawái no utiliza un proveedor externo de correo para sus centros dentro del estado. El correo personal entrante va directamente a OCCC, dirigido a la persona encarcelada en el centro. Los libros y revistas deben enviarse directamente del editor o de un proveedor aprobado. Consulte la guía de [Correo y paquetes](/states/hawaii/guides/mail/) para conocer las reglas de sobres y qué se rechaza.

Los teléfonos, las tabletas y las visitas por video funcionan a través de GTL (ViaPath), facturados mediante ConnectNetwork. Las tabletas permiten visitas por video durante horarios asignados, que es la forma en que las familias se conectan de manera remota. Los detalles sobre cuentas, costos de llamadas y visitas por video están en la guía de [Llamadas telefónicas y por video](/states/hawaii/guides/phone-video/), y los depósitos en la cuenta fiduciaria se explican en [Enviar dinero](/states/hawaii/guides/money/).
