...
providers:
  ...
  video: "GTL (ViaPath)"
visiting:
  scheduling: "Llame a la línea de visitas (ext. 244) para confirmar los días, el horario y si la visita debe reservarse con anticipación."
  videoVisits: true
links:
...
Las reglas estatales del DCR mencionadas arriba —el proceso de lista de visitantes aprobados, el código de vestimenta, los requisitos de identificación y los límites de artículos— se aplican en KCCC. Los arreglos propios del centro:
...
Los teléfonos, las tabletas y las visitas por video en KCCC son proporcionados por GTL (ViaPath), con las llamadas y los fondos de la cuenta facturados a través de ConnectNetwork. Las tabletas del centro permiten visitas por video durante horarios asignados, que es la forma en que las familias se conectan de manera remota con alguien en el centro. Los detalles sobre cómo configurar una cuenta y los costos de llamadas están en la guía de teléfono y video más abajo, y cómo agregar dinero se explica en la guía de dinero.

Hawái no utiliza un proveedor externo de escaneo de correo para sus centros dentro del estado. El correo personal entrante va directamente al centro, donde el personal lo abre e inspecciona antes de la entrega. Dirija el correo personal con el nombre completo y el número de la persona encarcelada a la dirección del centro. Las fuentes difieren en cuanto al número exacto de la calle del centro — la página del DCR del centro indica 3-5351 Kuhio Highway, mientras que el directorio estatal indica 5350 Kuhio Highway (ambos en Lihue, HI 96766). Confirme el formato de envío exacto y actual con el centro antes de enviar correo. Los libros, revistas y otras publicaciones deben enviarse directamente del editor o de un proveedor aprobado; las reglas sobre sobres, fotos y artículos rechazados están en la guía de correo más abajo.
