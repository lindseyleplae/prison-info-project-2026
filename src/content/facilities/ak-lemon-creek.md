...
summary: "A medium-security regional correctional center in Juneau, Alaska — the facility serving Southeast Alaska and the state capital, holding both pretrial and sentenced men and women."
...
Lemon Creek Correctional Center is a medium-security regional facility in Juneau that holds both men and women. Alaska runs a unified corrections system, so this facility holds people awaiting trial as well as people serving sentences. Confirm the person's current facility on [VINELink](https://www.vinelink.com/) before traveling or sending anything — people are moved between facilities without family notification. Juneau is not on Alaska's road system; it is reachable only by air or ferry, which makes confirming the person's location before a trip especially important. Personal mail goes directly to the facility (see [Mail](#mail)).
:::

:::key-info
- **Location:** Juneau, City and Borough of Juneau, in Southeast Alaska
- **Population:** Men and women, medium custody; both pretrial and sentenced
- **Notable:** The regional correctional center serving Southeast Alaska and the state capital; Juneau has no road connection to the rest of the state
- **Visitation:** By approved list; no statewide scheduler — confirm days and hours with the facility
:::
...
:::key-info
- **Approved list first:** After the first 24 hours of custody, each visitor must be on the prisoner's approved visitor list and must show a driver's license or other government-issued photo ID. A person can normally be on only one prisoner's list (with an exception for immediate family).
- **Scheduling:** There is no statewide online visit scheduler in Alaska. Confirm current visiting days, hours, and whether an appointment is required directly with the facility before traveling.
- **Days and hours:** Set by the facility and posted per institution; most visits run about one hour. Whether a visit is contact or non-contact depends on the person's custody level and housing unit.
- **Main line:** 907-465-6200
:::
