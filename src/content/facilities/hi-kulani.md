...
system: "HI DCR"
population: men
summary: "A remote minimum-security men's prison on the slope of Mauna Loa on the Big Island, known for Hawaiian-culture, education, and conservation programs."
aliases:
  - KCF
  - Kulani
city: Hilo
...
Kulani Correctional Facility is a remote minimum-security prison on the Big Island. People are transferred between Hawaii facilities, and between in-state facilities and the Saguaro Correctional Center in Arizona, without family notification, so confirm where the person is currently held on [VINELink](https://www.vinelink.com/) (Hawaii participates — select Hawaii, then search) before traveling or sending anything. Hawaii DCR does not use an off-site mail vendor: in-state personal mail goes directly to the facility (see [Mail](#mail)).
:::

:::key-info
- **Location:** On the slope of Mauna Loa, about 20 miles southeast of Hilo on Hawaii Island, off Stainback Highway
- **Population:** Men; minimum security
- **Notable:** Education, vocational, and Hawaiian-culture programs run in partnership with Hawaii Community College; conservation and forestry work
...
:::key-info
- **In person:** Hawaii has no single statewide visit scheduler; each prison posts its own visitation schedule and runs its own visitation line. Confirm visiting days, hours, and whether a visit must be booked in advance with the facility before traveling.
