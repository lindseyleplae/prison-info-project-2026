...
system: "NCDAC"
population: men
summary: "A close- and minimum-security state prison for men in Marion, in the western North Carolina mountains."
...
Marion Correctional Institution is a close- and minimum-security prison for men. Confirm the person's current facility on the [NCDAC offender search](https://webapps.doc.state.nc.us/opi/offendersearch.do?method=view) before traveling or sending anything — people are transferred without family notification. Personal mail does not go to the prison; it goes off-site to TextBehind (see [Mail](#mail)).
:::

:::key-info
- **Location:** Marion, McDowell County, in the western North Carolina mountains
- **Population:** Men, close and minimum custody
- **Notable:** A combination close/minimum facility with 96 segregation beds and a capacity of about 793; programs include the New Leash on Life dog-training program and the Father Accountability Program
...
:::key-info
- **Approved list first:** Before any visit, the incarcerated person mails a visiting application to each prospective visitor. Applicants 16 and older include a copy of a government photo ID; minors under 16 include a copy of a birth certificate. Completed forms go to Marion Correctional Institution.
