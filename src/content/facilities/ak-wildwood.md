...
system: "AK DOC"
population: men
summary: "A medium-security state correctional complex for men in Kenai, Alaska — one campus that combines the Wildwood Correctional Center (sentenced men), the Wildwood Pretrial Facility, and the Wildwood Transitional Program."
...
Wildwood Correctional Complex is a medium-security state corrections campus for men in Kenai. People are moved between facilities and between the units of this complex without family notification, so confirm where the person is currently held on [VINELink](https://www.vinelink.com/) (Alaska's statewide locator — select Alaska, then search) before traveling or sending anything. Alaska DOC does not use an off-site mail vendor: personal mail goes directly to the facility (see [Mail](#mail)).
:::

:::key-info
- **Location:** Kenai, Kenai Peninsula Borough, on the Kenai Peninsula in southcentral Alaska
- **Population:** Men; medium custody, with pretrial detention on the same campus
- **Notable:** A complex of three operations on one site — the Wildwood Correctional Center (sentenced men), the Wildwood Pretrial Facility, and the Wildwood Transitional Program
- **Visitation:** By the prisoner's approved visitor list, arranged with the facility; there is no statewide scheduler
:::
...
:::key-info
- **Approved list first:** After the first 24 hours in custody, every visitor must be on the prisoner's approved visitor list and must show a driver's license or other government-issued photo ID at the door. A person can normally be on only one prisoner's list. Visitors and their belongings are searched.
- **Scheduling:** There is no statewide online visit-booking system. Visiting hours are posted per facility on the Alaska DOC institutions website or available by calling the facility, and several Alaska facilities take visits by appointment — confirm days, hours, and whether an appointment is needed with Wildwood, and ask which unit of the complex the visit will be in.
- **Contact and non-contact:** Alaska uses Secure Visitation (which limits or prevents physical contact) and Contact Visitation (a brief hug allowed at the start and end only). Which applies depends on the person's custody level and housing unit. Most visits last about one hour.
- **Main line:** 907-260-7200
:::
