...
system: WDOC
population: men
summary: "Wyoming's high-custody men's prison, south of Interstate 80 at Rawlins — not to be confused with the original penitentiary downtown, which is now a museum."
aliases:
  - WSP
  - Rawlins
city: Rawlins
...
securityLevel: "High custody; also houses medium and minimum custody"
...
providers:
  phone: "ICSolutions"
  video: "The Visitor by ICSolutions (fee-based from home)"
visiting:
  days: "Friday-Monday — which sessions are available depends on the housing unit"
  hours: "8:30 a.m.-12:00 p.m. and 1:00-4:30 p.m."
  scheduling: "First come, first served — check-in 7:45-8:15 a.m. or 12:15-12:45 p.m.; visitor approval through the inmate-initiated application must come first."
  contactVisits: true
  videoVisits: true
links:
...
:::key-info
**Location:** South of Interstate 80 at Exit 214 (Higley Boulevard), outside Rawlins in Carbon County

**Capacity:** 826 in the South Facility, per WDOC — the state's high-custody men's prison, which also holds medium and minimum custody

**Notable:** Visiting days are assigned by housing unit, and the famous old penitentiary in downtown Rawlins is a museum, not this prison

**Visitation:** Friday-Monday sessions by housing unit; video visits from home through ICSolutions
:::
...
:::key-info
**Sessions:** 8:30 a.m.-12:00 p.m. and 1:00-4:30 p.m.; check-in 7:45-8:15 a.m. for morning and 12:15-12:45 p.m. for afternoon. Visitors running late must call ahead.

**By housing unit (posted schedule, effective May 2025):** Friday — A1, A2, B1, B2, H1, K1, K2; Saturday morning — B1, B2, H1; Saturday afternoon — H2; Sunday — A1, A2, H1, K1, K2; Monday — G2 (Youthful Offender Treatment Program) and special visits.

**ID:** Photo ID for all adults; WSP requires a birth certificate for all children.

**Vending:** Debit or credit card only — no cash.
:::

The posted schedule offers mid-session leave times at 10:00 a.m. and 2:00 p.m., with shuttle arrangements made through the visitation officer. Video visits run on ICSolutions' "The Visitor" system — registration is free, visits from home carry a fee that the vendor says varies by facility, and scheduling runs through icsolutions.com. The approval process, the 15-minute arrival window, and what you can bring are covered in [Visiting in Wyoming](/states/wyoming/guides/visiting/).
...
:::key-info
**From Cheyenne:** I-80 West, about 149 miles, roughly 2.5 hours

**From Casper:** WY-220 toward Muddy Gap, about 120 miles, roughly 2.5 hours

**From Salt Lake City:** I-80 East, about 290 miles, roughly 5 hours

**Winter:** I-80 across southern Wyoming closes in winter storms — check wyoroad.info, the Wyoming 511 app, or 1-888-996-7623 before traveling
:::
...
- [Visiting in Wyoming](/states/wyoming/guides/visiting/) — the inmate-initiated application, dress code, and scanner
- [Mail & Packages](/states/wyoming/guides/mail/) — the number-after-name addressing rule
- [Phone & Video Calls](/states/wyoming/guides/phone-video/) — the ICSolutions system and calling lists
- [Sending Money](/states/wyoming/guides/money/) — the visitor-list deposit requirement
- [Medical & Mental Health](/states/wyoming/guides/medical/) — the 24/7 family crisis line
- [Transfers](/states/wyoming/guides/transfers/) — intake, custody levels, and out-of-state placement
