...
summary: "A small mixed-custody Alaska DOC facility in Ketchikan, on an island in Southeast Alaska reachable mainly by air or ferry, holding both pretrial and sentenced men and women."
...
Ketchikan Correctional Center is a mixed-custody facility that holds both men and women and both pretrial and sentenced people. It sits on an island in Southeast Alaska that is reachable mainly by air or ferry — there is no road connection to the rest of the state — so in-person visits usually require travel planning. Confirm the person's current facility on [VINELink](https://www.vinelink.com/) before traveling or sending anything, because people are transferred between Alaska DOC facilities. Personal mail goes directly to the facility at the address below.
:::

:::key-info
- **Location:** Ketchikan, Ketchikan Gateway Borough, in Southeast Alaska
- **Population:** Men and women, mixed custody; both pretrial and sentenced
- **Notable:** A small Southeast Alaska facility on an island community reachable mainly by air or ferry
- **Visiting:** By approved visitor list; days and hours are set by the facility, with no statewide scheduler
:::
...
:::key-info
- **Approved list first:** After the first 24 hours of custody, every visitor must be on the prisoner's approved visitor list and must show a driver's license or other government-issued photo ID. Visitors and their belongings are searched before a visit.
- **Scheduling:** There is no statewide online scheduler. Visiting days, hours, and whether an appointment is needed are set by the facility — confirm the current schedule by calling the facility or checking its page on the Alaska DOC institutions website.
- **First 24 hours:** During the first 24 hours after someone is booked on new charges, family and friends may visit with valid government photo ID without being on an approved list; after that, the approved-list rule applies.
- **Contact vs. non-contact:** The facility offers both secure (non-contact) and contact visits; which one applies depends on the person's custody level and housing. Most visits last about one hour.
- **Main line:** 907-228-7350
:::
