...
system: "HI DCR"
population: men
summary: "A CoreCivic-run private prison in Eloy, Arizona that holds about 800 sentenced Hawaii men under contract, with its own visiting, mail, phone, and money rules."
aliases:
  - SCC
  - Saguaro
city: Eloy
...
visiting:
  ...
  scheduling: "Visitors must be approved in advance (a background check routed through Hawaii); video visits for the Hawaii population are booked through the state's mainland branch."
  contactVisits: true
  videoVisits: true
links:
...
Saguaro Correctional Center is a private prison in Eloy, Arizona, operated by CoreCivic, that holds about 800 sentenced men from Hawaii under contract. Its visiting, mail, phone, and money procedures differ from Hawaii's in-state facilities. The facility-specific rules below apply only at Saguaro.
:::

:::key-info
- **Location:** Eloy, Pinal County, Arizona — on the U.S. mainland
- **Operator:** CoreCivic, a private corrections company, under contract with Hawaii
- **Population:** Sentenced Hawaii men — about 800 as of April 2026
- **Visitation:** In-person visiting requires travel to Arizona and advance approval; video visits for the Hawaii population are booked through the State of Hawaii mainland branch
:::
...
- **Approved-visitor list:** The inmate submits the proposed visitor list, which is sent to Hawaii for a background (NCIC) check; the facility's chief of security then approves or denies it. The process takes about two to four weeks. Up to 10 people may be on the list, and up to 6 may visit at one time.
