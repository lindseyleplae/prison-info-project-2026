...
securityLevel: "All custody levels (men and women)"
...
providers:
  phone: "GTL (ViaPath)"
  video: "ThrIVE (no charge to visitors as published)"
visiting:
  days: "Friday-Sunday in-person (plus weekday evening sessions); Monday-Thursday video"
  scheduling: "Appointment only, through per-housing-unit sign-up forms on corrections.utah.gov — schedules are posted as monthly calendars per unit, and approval must come first (6-8 weeks)."
  contactVisits: true
  videoVisits: true
links:
...
**Important:** The old Utah State Prison in Draper closed in July 2022 and has been demolished — this facility replaced it. Old directions, addresses, and guides pointing to Draper or "the Point of the Mountain" are obsolete: the Minuteman Drive address in Draper that still appears online is UDC's administrative office, not a prison. Personal mail goes to PO Box 165300, Salt Lake City, UT 84116 — not to the facility street address.
:::

:::key-info
**Location:** Salt Lake City's far northwest corner, north of I-80 and about five miles west of the airport

**Capacity:** 3,600 beds on a 200-acre site, opened July 2022

**Notable:** Houses men and women across all custody levels, including statewide intake — housing units are named after Utah waterways

**Visitation:** In-person Friday-Sunday (two hours) by appointment; video visits Monday-Thursday on the free ThrIVE system
:::
...
:::key-info
**Days:** In-person visits Friday-Sunday, two hours, with evening in-person sessions continuing on some weekdays; video visits Monday-Thursday, 30 minutes.

**Schedule:** Posted as monthly calendars on UDC's Visitation Information page, with separate sign-up forms for Antelope, Currant, Dell, and a combined Bear/Green/Fremont form. Units rotate — check the current month before planning.

**Arrival:** 30 minutes early for in-person visits; the entry window closes 15 minutes after the scheduled start.

**Scheduling contact:** uspscheduleavisit@utah.gov or (801) 522-7046 — email is the reliable channel.
:::

Per UDC's facilities handbook, potential visitors can start submitting visiting applications while the person is still in Receiving & Orientation — useful, given the 6-8 week processing time. Video visits on ThrIVE are free as published, scheduled at least two business days ahead. Attorney visits run separately through the warden's office. The full approval process, dress code, and visit-frequency rules are in [Visiting in Utah](/states/utah/guides/visiting/).
...
:::key-info
**From downtown Salt Lake City:** I-80 West to the 7200 West exit; often about 20-25 minutes

**From the airport:** About five miles west, per UDC's description

**From Provo:** I-15 North to I-80 West; often about an hour

**From Ogden:** I-15 South to I-80 West; often about 50-60 minutes

**Entry:** Visitors check in at the Screening Building.
:::
...
- [Visiting in Utah](/states/utah/guides/visiting/) — UDC approval process, dress code, scheduling
- [Mail & Packages](/states/utah/guides/mail/) — the scanned-mail system and addressing format
- [Phone & Video Calls](/states/utah/guides/phone-video/) — rates, accounts, and free ThrIVE video visits
- [Sending Money](/states/utah/guides/money/) — deposits, fees, and the debt-withholding rule
- [Medical & Mental Health](/states/utah/guides/medical/) — healthcare and the family medical line
- [Transfers](/states/utah/guides/transfers/) — placement, the county jail program, and tracking moves
