...
system: "MN DOC"
population: men
summary: "A remote minimum-security state prison for men in Togo, Minnesota — the site of the Challenge Incarceration Program (CIP), Minnesota's intensive wilderness boot camp, in the former Thistledew Camp."
...
Minnesota Correctional Facility – Togo is a remote minimum-security prison for men in far northern Minnesota. Confirm the person's current facility on the [Minnesota DOC Offender Locator](https://coms.doc.state.mn.us/PublicViewer/Home/Index) before traveling or sending anything — people are transferred without family notification, and Togo is several hours by road from the Twin Cities. Personal mail does not go to the prison; it goes off-site to a TextBehind processing center for scanning (see [Mail](#mail)).
:::

:::key-info
- **Location:** Togo, Itasca County, in far northern Minnesota
- **Population:** Men, minimum custody (Level 1)
- **Notable:** The site of the Challenge Incarceration Program (CIP), Minnesota's intensive wilderness boot camp, in the former Thistledew Camp
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be approved. Visiting applications are mailed to the MN DOC central intake at MCF-Rush City (Attn: Visiting Unit). Confirm the current application form and process with the facility, as the DOC has been moving to an electronic application process.
- **Scheduling:** Confirm days, hours, and how visits are scheduled directly with the facility before traveling, because the schedule for a small program facility can differ from the larger prisons.
- **Video visits:** Available through JPay Video Connect.
- **Main line:** 218-376-7878
:::
...
> MCF-Togo, Minnesota (do not abbreviate Minnesota)
> P.O. Box 247
> Phoenix, MD 21131
