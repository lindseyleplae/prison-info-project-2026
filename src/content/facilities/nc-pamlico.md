...
system: "NCDAC"
population: men
summary: "A medium-security state prison for men in Bayboro, on the eastern North Carolina coast."
...
Pamlico Correctional Institution is a medium-security prison for men. Confirm the person's current facility on the [NCDAC offender locator](https://webapps.doc.state.nc.us/opi/offendersearch.do?method=view) before traveling. Personal mail goes to the off-site TextBehind vendor — see [Mail](#mail).
:::

:::key-info
- **Security level:** Medium security (men)
- **Location:** Bayboro, Pamlico County
- **Phone:** 252-692-6200
...
- **Scheduling:** Visits are by appointment only. North Carolina has no statewide online visit scheduler; call or email Pamlico Correctional Institution to schedule, and confirm the person's visitation status the day before.
