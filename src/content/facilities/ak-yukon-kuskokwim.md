...
summary: "A mixed-custody state correctional center in Bethel, Alaska, serving the Yukon-Kuskokwim Delta. It holds both pretrial and sentenced people and is in a remote community reachable mainly by plane."
...
Yukon-Kuskokwim Correctional Center is a mixed-custody facility in Bethel that holds both men and women. Alaska runs a unified system with no county jails, so this facility holds both pretrial and sentenced people. Confirm the person's current facility on [VINELink](https://www.vinelink.com/) (select Alaska) before traveling or sending anything — people are transferred without family notification. Bethel is not on Alaska's road system and is reached mainly by plane, so confirm details before booking travel. Alaska does not use an off-site mail vendor: personal mail goes directly to the facility (see [Mail](#mail)).
:::

:::key-info
- **Location:** Bethel, in the Bethel Census Area of southwest Alaska, on the Yukon-Kuskokwim Delta
- **Population:** Men and women, mixed custody; both pretrial and sentenced
- **Notable:** A regional facility serving the Yukon-Kuskokwim Delta; remote and reachable mainly by plane (no road access to Bethel)
- **Visitation:** By approved visitor list; no statewide scheduler — arranged with the facility
:::
...
:::key-info
- **Approved list first:** After the first 24 hours in custody, every visitor must be on the prisoner's approved visitor list and must show a driver's license or other government-issued photo ID. Visitors and their belongings are searched.
- **Scheduling:** There is no statewide online scheduler. Confirm the current visiting days and hours, and whether an appointment is required, with the facility before traveling.
- **Contact and secure visits:** Alaska facilities offer both contact visits and secure (non-contact) visits; which one applies depends on the person's custody status and housing. Special visits for families traveling a long distance can be approved case by case, which is relevant for a facility reachable mainly by plane.
- **Main line:** 907-543-5245
:::
