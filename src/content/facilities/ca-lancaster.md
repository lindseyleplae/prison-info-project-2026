...
securityLevel: "Mixed (Levels I, III, IV)"
...
visiting:
  scheduling: "CDCR does not publish LAC's visiting days and hours on its public pages; the current schedule is shown in the Visitation Scheduling Application (VSA) and by phone."
  contactVisits: true
links:
...
:::key-info
**Location:** The Antelope Valley high desert, west of Lancaster, about 70 miles north of downtown Los Angeles

**Capacity:** Designed for about 2,300; CDCR's weekly population reports list counts above design capacity

**Notable:** The first and only state prison in Los Angeles County, with a medical hub mission for enhanced outpatient mental health care

**Visitation:** In-person visiting is operating; CDCR publishes the current schedule through VSA rather than on its public pages
:::
...
:::key-info
**Schedule:** Not published on CDCR's public pages. The current schedule is visible in VSA when scheduling, or by calling the institution at (661) 729-2000.
...
CDCR does not publish whether family (overnight) visits are available at LAC. Statewide rules, dress code, and the approval process are covered in [Visiting in California](/states/california/guides/visiting/).
...
:::key-info
**From downtown Los Angeles:** I-5 North to CA-14 North to Lancaster, then west on Avenue J or a parallel avenue to 60th Street West; often about 1.25-1.75 hours depending on traffic

**From the San Fernando Valley:** CA-14 North from the I-5 interchange; often about an hour

**From Bakersfield:** CA-58 East to Mojave, then CA-14 South to Lancaster; often about 1.5 hours
