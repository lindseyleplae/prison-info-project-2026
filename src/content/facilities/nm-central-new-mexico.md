...
system: "NMCD"
population: men
summary: "A multi-level state prison for men in Los Lunas, New Mexico, that houses the state's men's Reception and Diagnostic Center along with geriatric, mental-health, and long-term-care units."
city: "Los Lunas"
county: "Valencia"
address: "1525 Morris Road, Los Lunas, NM 87031"
securityLevel: "Multi-level (men)"
...
Central New Mexico Correctional Facility is the state's intake point for newly sentenced men, who are evaluated and classified at the Reception and Diagnostic Center over a period of weeks and then often transferred to another prison. A person may be here only briefly. Confirm the person's current facility on the [NMCD Offender Search](https://www.cd.nm.gov/offender-search/) before traveling or sending anything. Incoming personal mail goes off-site to a Securus processing center in Florida, not to the prison — see Mail below.
:::

:::key-info
- **Location:** Los Lunas, Valencia County, central New Mexico
- **Population:** Men, multi-level custody (Levels 1–3)
- **Role:** Houses the state's men's Reception and Diagnostic Center, plus a Geriatric Unit, a Mental Health Treatment Center, and a Long Term Care Unit
- **Phone:** (505) 383-3300
...
:::key-info
- **Days and hours:** Set by the facility. Confirm the current visiting schedule directly with CNMCF.
- **Scheduling:** Visits are arranged with the facility; there is no statewide online scheduler.
- **Approved list:** Every visitor must be on the inmate's approved visitor list before any visit.
- **Reception period:** Visiting may be limited or unavailable while a person is being processed at the Reception and Diagnostic Center. Confirm whether visits are allowed, and at what facility, before traveling.
- **Contact visits:** Available depending on custody level and housing unit.
:::
