...
system: "Iowa DOC"
population: men
summary: "A medium-security men's prison in Anamosa, built of local limestone in the 1870s, with a minimum-security prison farm satellite at Luster Heights."
aliases:
  - ASP
city: Anamosa
county: Jones
...
:::key-info
- **Approved list first:** Before any visit, each visitor must be approved. Iowa uses a Centralized Visiting Authority, and an approved list stays valid if the person is transferred.
- **Scheduling:** After approval, visits and video visits are scheduled through the Ameelio Connect app. Confirm the current process with the facility before a first visit.
...
Each Iowa facility has a numeric Facility ID code that must appear in the address along with the person's name and offender ID number. Anamosa State Penitentiary's confirmed Facility ID code is **1106**. The [Mail & Packages](/states/iowa/guides/mail/) guide has the exact Pigeonly address and the full addressing format.
