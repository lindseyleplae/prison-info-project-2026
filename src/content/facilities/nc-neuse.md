...
system: "NCDAC"
population: men
summary: "A medium-security state prison for men in Goldsboro, in eastern North Carolina."
...
Neuse Correctional Institution is a medium-security prison for men. Confirm the person's current facility on the [NCDAC offender locator](https://webapps.doc.state.nc.us/opi/offendersearch.do?method=view) before traveling. Personal mail goes to the off-site TextBehind vendor — see [Mail](#mail).
:::
...
- **Scheduling:** Visits are by appointment only. North Carolina has no statewide online visit scheduler; call or email Neuse Correctional Institution to schedule, and confirm the person's visitation status the day before.
