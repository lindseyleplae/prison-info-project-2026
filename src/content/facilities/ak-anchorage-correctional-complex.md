...
system: "AK DOC"
population: men
summary: "A state correctional complex for men in Anchorage, Alaska — the Anchorage-region booking and intake hub of Alaska's unified jail-and-prison system, holding both pretrial and sentenced men across two buildings (ACC East and ACC West)."
city: "Anchorage"
county: "Anchorage"
address: "1400 East 4th Avenue, Anchorage, AK 99501"
securityLevel: "All custody levels (men)"
...
visiting:
  ...
  scheduling: "Every visitor must be on the prisoner's approved visitor list (with a photo ID); in the first 24 hours after booking, visits are allowed without the list. There is no statewide scheduler — confirm days, hours, and whether an appointment is needed with the facility."
  contactVisits: true
links:
...
Anchorage Correctional Complex is a state correctional complex for men and the main booking and intake point for the Anchorage region, so the people it holds change frequently and are often moved to other facilities after intake. Confirm the person's current facility on [VINELink](https://www.vinelink.com/) (select Alaska) before traveling or sending anything — people are transferred without family notification. Personal mail goes directly to the facility, not to an off-site vendor (see [Mail](#mail)).
:::

:::key-info
- **Location:** Anchorage, in south-central Alaska
- **Population:** Men, all custody levels — both pretrial (unsentenced) and sentenced
- **Notable:** The Anchorage-region booking and intake hub of Alaska's unified jail-and-prison system; two buildings (ACC East and ACC West) plus an acute psychiatric and medical unit
- **Visitation:** By approved visitor list, with visits allowed in the first 24 hours after booking without the list; arrangements set by the facility
:::
...
:::key-info
- **Approved list, with a first-24-hour exception:** After the first 24 hours, every visitor must be on the prisoner's approved visitor list and must show a driver's license or other government-issued photo ID. During the first 24 hours after a person is booked on new charges, family and friends may visit without being on the list — bring valid government ID to the front desk.
- **Scheduling:** There is no statewide online scheduler. Confirm the current visiting days, hours, and whether an appointment is required by checking the [Alaska DOC institutions page](https://doc.alaska.gov/institutions) or calling the facility.
- **Days and hours:** Set by the facility. Visits are typically about one hour. Whether a visit is contact (a brief hug allowed at the start and end) or non-contact depends on the person's custody level and housing unit.
- **Main line:** 907-269-4100
:::
