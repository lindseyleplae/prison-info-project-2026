---
title: "Transfers & Finding Someone in Florida (FDC)"
slug: transfers
state: fl
topic: transfers
relatedNationalGuide: visiting-basics
system: FDC
description: "How Florida reception and classification works, how to find where a person is held using the FDC Corrections Offender Network by name or DC number, and how classification, transfers, and privately operated prisons affect a person's location."
sources:
...
**Find a person with the FDC Corrections Offender Network.** Search by name or by **DC number** at the FDC Corrections Offender Network.

**A newly committed person starts at a reception center.** For men, intake is at the **Reception and Medical Center** (Lake Butler), the **Central Florida Reception Center** (Orlando), the **South Florida Reception Center** (Doral), and the **Northwest Florida Reception Center** (Panhandle); for women, intake is at **Lowell Correctional Institution** (Ocala).

**Where a person is held can change.** Classification and transfers move people between institutions — confirm the **current institution** on the offender search.

**County jails are separate.** People held in county jails are **not** in the FDC offender search.
:::
...
:::reality-check{title="Confirm the institution before traveling"}
Because people are **transferred** after classification, the institution where a person was last known to be held may have changed. Confirm the **current institution** on the FDC Corrections Offender Network before traveling for a visit, and confirm that institution's current visiting details.
:::

## Verify Before Acting

:::callout{variant="warning" title="Verify Before Acting"}
Confirm the person's **current institution** on the FDC Corrections Offender Network — by **name** or **DC number** — before relying on any plan. A newly committed person starts at a **reception center** (the **Reception and Medical Center**, **Central Florida Reception Center**, **South Florida Reception Center**, or **Northwest Florida Reception Center** for men; **Lowell** for women) and is then **transferred**, so the reception center is usually not the long-term location. People held in Florida's **privately operated prisons** are still found through the **same FDC offender search**. People in **county jails** are **not** in the FDC offender search and are tracked separately by each sheriff.
:::
