...
-   **Account type:** CDCR Inmate Trust Account, identified by the person's name and CDCR number
-   **Online deposits:** CDCR lists GTL/ConnectNetwork, JPay, and Access Corrections as approved electronic deposit vendors
-   **Mailed deposits:** Money order, cashier's check, or personal check — never cash
-   **Critical deduction rule:** CDCR withholds up to 55% of a deposit when the person owes restitution
-   **Monthly canteen limit:** CDCR's maximum monthly canteen draw is $300 (CCR Title 15 §3090(b))
:::
...
| Method | Fee | Posting time |
| --- | --- | --- |
| Online vendor (GTL/ConnectNetwork, JPay, Access Corrections) | Vendor service fee, varies by amount | Within 1–3 days |
| Lockbox money order or cashier's check | No deposit fee | After processing |
| Lockbox personal check | No deposit fee | Held 10 business days |
| Mailed directly to institution | No deposit fee | 30-day hold |

:::callout{variant="tip"}
The lockbox and direct-to-institution methods have no deposit fee, but they post more slowly than an electronic deposit. An online vendor deposit posts within 1–3 days but adds a service fee.
:::
...
CDCR automatically withholds money from deposits when the incarcerated person owes court-ordered restitution. CDCR takes 50% of the deposit (or the balance owed, whichever is less) toward the obligation, plus an administrative fee of 10% of that deduction — a maximum total deduction of 55%. A $100 deposit can leave $45 available to spend.
:::
...
:::reality-check
When a family member reports that a deposit "did not all arrive," the difference is most often the restitution deduction, not a posting error.
:::
...
-   Quarterly packages from approved vendors are separate from the canteen draw. See [Mail & Packages](/states/california/guides/mail/) for package rules.

## Verify Before Acting

:::callout{variant="warning" title="Verify Before Acting"}
Vendor fees and posting times change more often than CDCR's underlying rules, and California is updating its communication and tablet vendors during 2026. Confirm the current deposit fee at checkout, use the correct lockbox coupon, and account for the restitution deduction before sending money. Never mail cash.
:::
