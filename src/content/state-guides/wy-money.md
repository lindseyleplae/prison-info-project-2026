---
title: "Sending Money in Wyoming (WDOC)"
slug: money
state: wy
topic: money
relatedNationalGuide: sending-money
system: WDOC
description: "How deposits work in Wyoming — the visitor-list requirement, Access Corrections fees, money orders by mail, what gets deducted, and how commissary works."
sources:
...
**Wyoming's distinctive rule: you must be on the person's approved visitor list to deposit money.** WDOC's published instruction is explicit about it.

**Vendor:** Access Corrections — online, by phone (1-866-345-1884), or walk-in.

**Fees (as posted on WDOC's page, June 2026):** "as low as" $2.95 online, $3.95 by phone; $5.95 flat at walk-in locations.

**Staff will not confirm your deposit arrived** — the published policy makes the incarcerated person responsible for confirming receipt.
:::

## The Visitor-List Requirement

Before anything else: WDOC's published deposit instruction states that to put money on a Wyoming inmate's account, **you must be on that person's approved visitor list**. Wyoming ties deposits and visiting together. If you have not gone through the visitor application described in [Visiting in Wyoming](/states/wyoming/guides/visiting/), arrange that first — the deposit channels check against the same list.
...
Government, business, tax-refund, attorney-settlement, estate, and retirement-account checks can be deposited but may be held for authentication. Mail the money order to the person at their facility's mailing address — the addressing rules in [Mail & Packages](/states/wyoming/guides/mail/) apply.
...
WDOC's deposit page posts "as low as" fees without a date, and the visitor-list requirement means a deposit can fail for list reasons rather than payment reasons. Confirm the person's WDOC number in the Wyoming Offender Locator, confirm you are on their approved visitor list, and check the fee shown in the Access Corrections transaction before completing it. For someone held in a county jail or out of state, these WDOC channels may not apply — confirm with the holding facility.
:::
