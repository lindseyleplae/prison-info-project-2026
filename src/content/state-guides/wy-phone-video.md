---
title: "Phone & Video Calls in Wyoming (WDOC)"
slug: phone-video
state: wy
topic: phone-video
relatedNationalGuide: staying-in-touch
system: WDOC
description: "How calls work from Wyoming prisons on the ICSolutions system — the 20-number list, daily limits, account types, and video visits from home."
sources:
...
**Calls are outbound only**, to a pre-approved list of up to 20 numbers. Staff place free emergency calls when there's a death or hospitalization among immediate family or approved visitors.

**Daily limits:** up to 120 minutes of phone time per day, 30 minutes per call, no calls between 10 p.m. and 6 a.m.

**Vendor:** ICSolutions — the same account handles phone funding and video visits.

**Rates are not published.** The live rate shows in an ICSolutions account; WDOC posts no rate sheet.
:::
...
Special video visits can be approved for significant family events — funerals, weddings, baptisms — through the special-visit request process described in [Visiting in Wyoming](/states/wyoming/guides/visiting/).
...
Wyoming's telephone policy was reissued effective July 2026, and phone rates are published only inside the ICSolutions system. Confirm the current rate when funding an account at icsolutions.com, and remember that adding your number to the calling list happens on the incarcerated person's side — on a 90-day change cycle.
:::
