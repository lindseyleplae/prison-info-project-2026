---
title: "Atención médica y salud mental en Alabama (ADOC)"
slug: medical
state: al
topic: medical
relatedNationalGuide: know-your-rights
system: ADOC
description: "El copago médico de $4 de Alabama y sus exenciones, el contratista privado de atención médica, cómo pueden las familias plantear una inquietud de salud, y el hecho de que Alabama no tiene un defensor del pueblo (ombudsman) penitenciario independiente."
sources:
...
**Hay un copago de $4 para las consultas solicitadas por el recluso**, pero las consultas de salud mental, abuso de sustancias, emergencia, embarazo, atención crónica e ingreso están exentas, y a nadie se le niega atención por no poder pagar.

**Una empresa privada presta la atención médica** (NaphCare, el contratista a partir de 2026); el proveedor cambia, pero ADOC fija las reglas.

**La información de salud requiere la autorización por escrito del recluso,** y las familias no tienen un portal formal para quejas médicas.

**Alabama no tiene un defensor del pueblo (ombudsman) penitenciario independiente.**
:::
...
Cuente con un copago de $4 para las consultas solicitadas por el recluso, con amplias exenciones y sin que se niegue la atención por no poder pagar. Para plantear una inquietud, comuníquese con el administrador de servicios de salud (Health Services Administrator) de la institución o con la oficina central de ADOC, y tenga presente que los detalles clínicos requieren la autorización por escrito del recluso. Como Alabama no tiene un defensor del pueblo (ombudsman) penitenciario independiente, confirme la vía de escalamiento vigente con la institución.
:::
