---
title: "Mail and Packages in Texas (TDCJ)"
slug: tx-mail
state: tx
topic: mail
...
-   **Personal mail address:** PO Box 660400, Dallas, TX 75266-0400
-   **Delivery method:** Personal mail is scanned and uploaded to the person's tablet
-   **Timing:** Mail is typically available within three business days
-   **No-tablet access:** TDCJ prints black-and-white copies for people without tablets
-   **Books and media:** Sent directly to the unit, not to Dallas
-   **Personal packages:** Not accepted from individuals
:::
...
:::callout{variant="tip"}
The envelope must include the person's full commitment name and TDCJ number. If identifying information is incomplete, the mail can be returned.
:::
...
:::reality-check
Digital delivery changes the format of the mail. The person inside receives the scanned image on a tablet, not the original physical photo, unless a unit exception applies.
:::
...
Do not send books to the Dallas digital mail address. Books, magazines, and similar materials sent there are returned.
:::
...
-   TDCJ's approved package-style commissary program is [eCommDirect](https://www.texas.gov/eCommDirect).
...
Texas mail rules changed significantly with the 2023 digital-mail rollout and the 2026 book-policy revision. Confirm the current mailing category and address before sending personal mail, books, or eCommDirect purchases.
:::
