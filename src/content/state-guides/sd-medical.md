---
title: "Medical & Mental Health in South Dakota (SD DOC)"
slug: medical
state: sd
topic: medical
...
**Care is provided in-house by SD DOC Health Services** — the department's own Health Services division staffs on-site primary care, behavioral health, dental, optometry, lab, and x-ray across the prison system rather than contracting it to a single for-profit company.

**There is no named statewide private medical contractor.** Day-to-day care is delivered by the agency's own Health Services staff.

**Specialty and telemedicine care is provided through the Avera health system,** which supplies specialty consultations and telehealth that the prison clinics cannot provide on site.

**Health complaints go through the SD DOC grievance process,** starting with the facility's medical staff.
:::
...
Confirm the current health-services request procedure, whether a co-pay applies and its amount, and grievance deadlines with the facility's health services unit, because details change. A health or treatment concern that cannot be resolved at the facility may be raised through the SD DOC grievance process — South Dakota has no separate independent corrections ombudsman.
:::
