---
title: "Transfers & Finding Someone in Alabama (ADOC)"
slug: transfers
state: al
topic: transfers
...
**The dividing line is the offense.** Felony sentences go to ADOC; people awaiting trial or serving short misdemeanor time are held in **county jails**.

**Many state-sentenced people wait in county jails.** Because of crowding, a person sentenced to ADOC may stay in the county jail for a while before being transferred.

**New arrivals start at a reception center** — men at **Kilby**, women at **Tutwiler**.

**Find someone with the ADOC Inmate Search** (by name or AIS number); sign up for **AlaVINE** for custody alerts.
:::
...
Check the ADOC Inmate Search first; if the person is not listed, they may still be in a county jail — including state-sentenced people awaiting transfer — so check the county sheriff's roster as well. Expect a newly sentenced person to appear at a reception center (Kilby for men, Tutwiler for women) before moving to a permanent facility, and confirm the current location before traveling.
:::
