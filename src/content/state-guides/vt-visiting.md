---
title: "Visiting in Vermont (DOC)"
slug: visiting
state: vt
topic: visiting
relatedNationalGuide: visiting-basics
system: VTDOC
description: "How Vermont's visitor list works, the no-contact rule for visitors over 11, walk-in visiting by housing unit, and the new family-support law."
sources:
...
**The incarcerated person submits the visitor list** — up to 10 names, changeable every 90 days.

**The contact rule surprises everyone:** Vermont's handbook bars physical contact with any visitor **over age 11** — no hugs, hands on the table.

**Visits are walk-in**, during the posted block for the person's housing unit — one visit a week, up to two hours.

**Don't arrive late:** visitors arriving in the last 30 minutes of a visiting period are not processed.
:::
...
Video visiting runs through DOC's communications vendor, ICSolutions, priced at a published **16 cents per minute** plus applicable taxes. Registration runs through icsolutions.com; DOC publishes little else about scheduling mechanics, so the vendor account is where availability shows. Details on the phone system — including the two free calls per week — are in [Phone & Video Calls](/states/vermont/guides/phone-video/).

## If Someone Is in Mississippi

Vermont houses a group of men at a contract facility in Mississippi, where visiting follows that facility's rules and Vermont's posted guidance is dated — the practical channels are covered in [Transfers](/states/vermont/guides/transfers/).
...
Vermont's governing visiting directive dates to 2006 and its handbook to 2022, and where they differ — the contact rule above is the clearest case — practice follows the newer, stricter reading. Facility schedules are posted without dates and turn on housing-unit assignments, so confirm the person's unit and block by phone before traveling, especially for the weekly one-visit allowance you don't want to spend on a turned-away trip.
:::
