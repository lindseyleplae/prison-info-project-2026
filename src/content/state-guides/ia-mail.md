---
title: "Mail in Iowa (Iowa DOC)"
slug: mail
state: ia
topic: mail
relatedNationalGuide: staying-in-touch
system: "Iowa DOC"
description: "How Iowa's off-site Pigeonly mail-scanning system works, the exact address and facility ID code to use, and the rules for photos and legal mail."
sources:
...
**Personal mail is scanned off-site — it does not go to the prison.** Since 2022, incoming personal (non-legal) mail to an Iowa Department of Corrections incarcerated individual goes to a third-party vendor, **Pigeonly**, in Las Vegas, Nevada. Pigeonly opens and scans each item and delivers a copy to the facility.

**Mail sent directly to an Iowa prison is returned.** Use the Pigeonly address, with the correct facility name and facility ID number, for all personal mail.

**The address must include the offender ID number and the facility ID number.** Each facility has a numeric facility ID code that must appear on the envelope.

**Legal and privileged mail goes to the facility — not to Pigeonly.** Mail from courts and attorneys goes directly to the prison where the person is housed.
:::
...
Personal mail sent to a prison's own address instead of the Pigeonly box in Las Vegas is returned to the sender. Money cannot be enclosed with a personal letter as a way to deposit funds — see [Sending Money](/states/iowa/guides/money/) for how to add money to a trust account.
:::
...
Send personal letters, cards, and photos to the Pigeonly center (PO Box 96777, Las Vegas, NV 89193) with the incarcerated individual's name, offender ID number, the facility name, and the facility ID number — but send legal and privileged mail to the facility's own address. Confirm the facility ID number and the current rules for photos, books, and packages on the Iowa DOC "How Do I Write an Offender" page, since each facility differs and mail rules change. The Iowa DOC mail page is the authoritative source.
:::
