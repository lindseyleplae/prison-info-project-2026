---
title: "Transfers & Facility Changes in CDCR"
slug: transfers
state: ca
topic: transfers
...
-   **Location tool:** California Incarcerated Records & Information Search (CIRIS) at [ciris.mt.cdcr.ca.gov](https://ciris.mt.cdcr.ca.gov/), which has replaced the older inmate locator.
-   **Family notice:** CDCR does not directly notify families of routine transfers; location is usually learned from the person or from CIRIS.
-   **Reception centers:** Newly committed people are processed at a reception center before assignment to a permanent institution.
-   **Visiting approval:** Approval and scheduling are handled per institution, so a transfer can require confirming or re-establishing approval at the new prison.
-   **Contact gap:** Phone, mail, and tablet access can be interrupted during a move and the period right after arrival.
:::
...
:::steps
1. Go to [ciris.mt.cdcr.ca.gov](https://ciris.mt.cdcr.ca.gov/).
1. Search by name or CDCR number.
1. Confirm the current institution before sending mail, money, or planning a visit.
:::
...
:::reality-check
There is often a gap between an actual move and the point when CIRIS shows the new location. That gap is longest during intake, medical transit, or restrictive housing.
:::
...
-   Approval and scheduling details are covered in [Visiting in California](/states/california/guides/visiting/).
...
-   See [Mail & Packages](/states/california/guides/mail/) for address format and what can be sent.
...
-   California is also changing its communication vendor from ViaPath to Securus across 2026, which can affect tablet and calling service around the same time as a move. See [Phone & Video Calls](/states/california/guides/phone-video/).

## Verify Before Acting

:::callout{variant="warning" title="Verify Before Acting"}
Do not rely on an old institution assignment, prior mailing address, or previous visit approval after a transfer. Check CIRIS and confirm the destination institution's visiting and mail rules before sending mail, money, or visitors.
:::
