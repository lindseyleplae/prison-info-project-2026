---
title: "Transfers & Finding Someone in Virginia (VADOC)"
slug: transfers
state: va
topic: transfers
relatedNationalGuide: know-your-rights
system: VADOC
description: "The one-year line between a state prison and a local jail, where intake happens, how to find someone, and what parole abolition means for release in Virginia."
sources:
  - name: "VADOC — Inmate & Supervisee Locator"
    url: "https://vadoc.virginia.gov/general-public/inmate-and-supervisee-locator/"
  - name: "Code of Virginia, Title 53.1, Chapter 2 — State Correctional Facilities"
    url: "https://law.lis.virginia.gov/vacodefull/title53.1/chapter2/"
  - name: "Virginia Criminal Sentencing Commission — Truth-in-Sentencing in Virginia"
    url: "http://www.vcsc.virginia.gov/Mar_05/TIS_Brochure.pdf"
  - name: "Code of Virginia § 53.1-165.1 — Persons eligible for parole"
    url: "https://law.lis.virginia.gov/vacode/title53.1/chapter4/section53.1-165.1/"
  - name: "VADOC — About Us"
    url: "https://vadoc.virginia.gov/about/"
lastReviewed: 2026-06-12
---

:::key-info{title="Key info"}
**The one-year line decides where a sentence is served.** A felony sentence of one year or more (for a crime on or after January 1, 1995) goes to state custody; under 12 months, and most detention before trial, stays in a local or regional jail.

**"State custody" does not always mean a state prison.** Virginia holds many state-responsible people in local and regional jails, sometimes for an entire sentence.

**Find someone with the VADOC Inmate & Supervisee Locator** — it covers state-responsible people, including those held in a jail under VADOC authority. If a person is not listed, they are likely local-responsible.

**Virginia abolished parole in 1995.** For most crimes since then, a person serves at least about 85% of the sentence.
:::
...
Confirm where a person is actually held before relying on any rules — a VADOC prison or a local or regional jail decides which apply. Start with the Inmate & Supervisee Locator; if the person is not listed, check the city or county jail. For a jail, that sheriff's office is the only source for its visiting, mail, and phone rules.
:::
