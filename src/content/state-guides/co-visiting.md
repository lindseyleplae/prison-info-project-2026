---
title: "Visiting in Colorado (CDOC)"
slug: visiting
state: co
topic: visiting
...
sources:
  ...
  - name: "CDOC — General Information and Approval Process"
    url: "https://cdoc.colorado.gov/resources-faq/visitation/general-information-and-approval-process"
  - name: "CDOC — Visiting Applications"
    url: "https://cdoc.colorado.gov/resources-faq/visitation/visiting-applications"
  - name: "CDOC — Visit an Incarcerated Individual (visit types)"
    url: "https://cdoc.colorado.gov/resources-faq/visit-an-incarcerated-individual"
  - name: "Colorado HB25-1013 (2025) — Correctional Facility Social Visitation Rights"
    url: "https://leg.colorado.gov/bills/HB25-1013"
lastReviewed: 2026-06-13
---

:::key-info{title="Key info"}
**Apply to the facility, and get approved first.** Each visitor applies to the specific prison where the person is held; the approved list is capped at **12 adults** (children do not count).

**The dress code bans green and look-alike colors.** Colorado uniforms are green, so **no green, gray, orange, white, yellow, or camouflage**; clothing must reach the knee and not be revealing.

**Bring a photo ID and one card for vending.** The only item allowed into the visit room for purchases is a single debit or credit card — no cash.

**Days, hours, and scheduling are set by each prison.** Most visits are by appointment, arranged with that facility.
:::
...
- **Phone calls** are now treated as a form of visitation, and Colorado covers the cost, so calls are **free to families**. See [Phone & Video Calls](/states/colorado/guides/phone-video/).
