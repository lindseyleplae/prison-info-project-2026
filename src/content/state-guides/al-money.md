---
title: "Sending Money in Alabama (ADOC)"
slug: money
state: al
topic: money
relatedNationalGuide: sending-money
system: ADOC
description: "How to deposit to an Alabama inmate's trust account through Access Corrections — online, by phone, with cash, or by money order to a St. Louis P.O. box — the payee name, the per-deposit cap, and where to confirm fees."
sources:
...
**Money goes to the Inmate Trust Fund through Access Corrections** — Alabama's deposit vendor.

**Four ways to send it:** online at accesscorrections.com, by phone, with cash at a partner location, or by money order through the mail.

**By mail, the money order is payable to "Access Secure Deposits"** and goes to the St. Louis P.O. box with the deposit slip. Deposit limits vary by method.

**Fees vary by method** — confirm at the vendor; money orders generally have the lowest fee.
:::
...
Have the inmate's **AIS number** ready, and confirm the current fee at Access Corrections before depositing. For the lowest cost, mail a money order payable to "Access Secure Deposits" with the deposit slip; for speed, use the website or phone line. Send funds only through Access Corrections — not to the prison directly.
:::
