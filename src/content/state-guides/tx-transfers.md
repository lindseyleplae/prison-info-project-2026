---
title: "Transfers and Facility Changes in Texas (TDCJ)"
slug: tx-transfers
state: tx
topic: transfers
...
-   **Transfer housing:** Some people move through transfer facilities before a permanent assignment.
-   **Mail and phones:** Mail forwarding is not guaranteed, and phone access may be interrupted after a move.
:::
...
1. Confirm the current unit assignment.
1. Recheck before travel because location and visitation status can change.
:::
...
:::callout{variant="tip"}
After a transfer, confirm both the new location and the current visitation eligibility before trying to schedule a visit.
:::
