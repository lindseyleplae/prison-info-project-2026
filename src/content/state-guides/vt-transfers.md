---
title: "Transfers & Facility Placement in Vermont (DOC)"
slug: transfers
state: vt
topic: transfers
relatedNationalGuide: know-your-rights
system: VTDOC
description: "How Vermont places and moves people — women to South Burlington, men by region, the Mississippi contract facility, and how to track someone."
sources:
  - name: "Vermont DOC — About Us (unified system)"
    url: "https://doc.vermont.gov/about-us"
  - name: "Vermont DOC Policy 312 — Facility Designation and Housing (effective February 2026)"
    url: "https://outside.vermont.gov/dept/DOC/Policies/Facility%20Designation%20and%20Housing%20Policy.pdf"
  ...
  - name: "Vermont DOC — Out-of-state housing contract with CoreCivic (September 2023)"
    url: "https://doc.vermont.gov/press-release/vermont-doc-announces-out-state-housing-contract-corecivic"
  - name: "Vermont DOC — Population Data"
    url: "https://doc.vermont.gov/research-and-data/population-data"
lastReviewed: 2026-06-12
---

:::key-info{title="Key info"}
**One agency runs everything** — Vermont DOC handles pretrial detention, prison, and supervision, with no county jails.

**Women go to one place:** after arraignment, women are transferred to the Chittenden facility in South Burlington.

**About 150 Vermont men are in Mississippi**, at a contract facility — sentenced men only, and family emergencies are a published priority for return.

**After an in-state transfer, the visiting list stays active for 30 days** — then a new list must be submitted.
:::
...
Vermont's placement policy was issued in February 2026 and its population pressures are actively reshaping where people are held — including how many are in Mississippi. After any move, confirm the person's location through the Offender Locator before mailing or traveling, and remember the 30-day visiting-list clock at the new facility: if the move sticks, a new list needs to go in before the old approvals lapse.
:::
