---
title: "Visiting in Alabama (ADOC)"
slug: visiting
state: al
topic: visiting
...
**Visitors must be on the approved list.** The inmate builds the list (Form 303-A), and every adult applicant gets a background check. An inmate may have up to eight approved adult visitors at a time.

**Newly arrived people wait.** A person may face up to a **60-day wait after intake** before visits can begin.

**The dress code is built around white.** Alabama inmates wear white, so no tan or tan-looking clothing and no scrubs; clothing must be knee-length and not tight or sheer.

**All visits must be pre-scheduled, and ADOC does not post hours online.** Days and hours vary by facility.
:::
...
Get on the inmate's list first, expect a possible wait of up to 60 days after intake, and dress with the no-tan, knee-length rule in mind. Because all visits must be pre-scheduled and ADOC does not post hours online, call the specific prison to confirm its visiting days and process before traveling.
:::
