---
title: "Mail & Packages in Wyoming (WDOC)"
slug: mail
state: wy
topic: mail
...
**Originals are delivered.** Incoming mail passes an electronic contraband scan, then the actual letter goes to the person — Wyoming has not switched to photocopy delivery.

**The addressing trap:** the WDOC number must come immediately after the name. Mail with the number anywhere else is returned unprocessed.

**Per letter:** up to 10 photos (8 x 10 max) and 10 newspaper or magazine clippings.

**No packages from home, no exceptions.** Books and magazines come only from the publisher.
:::
...
Wyoming updated its mail policy in March 2026, adding the scanning requirement — older instructions may not reflect it. Confirm the person's WDOC number and facility in the Wyoming Offender Locator before mailing, put the number immediately after their name, and check the current policy on WDOC's policies page if sending anything beyond a simple letter.
:::
