---
title: "Transfers & Facility Placement in Wyoming (WDOC)"
slug: transfers
state: wy
topic: transfers
relatedNationalGuide: know-your-rights
system: WDOC
description: "Where people go after sentencing in Wyoming — intake at Torrington or Lusk, county jail and out-of-state placement, and how to track someone through the Offender Locator."
sources:
...
**Intake:** men enter the system at the Medium Correctional Institution in Torrington; women at the Women's Center in Lusk. **No visits during intake.**

**Not everyone is in a Wyoming prison:** WDOC also holds people in county jails and, currently, at a contract facility in Mississippi.

**The locator caveat:** someone housed out of state shows in the Wyoming Offender Locator only as "In Custody" — it does not say where.

**WDOC does not notify families of transfers** — registering with the free VINE service is the published way to get automated custody updates.
:::
...
-   **Mail** must be re-addressed to the new facility immediately — each facility receives its own mail, and the addresses are in [Mail & Packages](/states/wyoming/guides/mail/)
...
Population placements shift — the county-jail and out-of-state figures above are daily averages from WDOC's early-2026 quarterly report, and WDOC describes the out-of-state placements as temporary. Before traveling or mailing anything after a move, confirm the person's location in the Wyoming Offender Locator, and if it shows only "In Custody," confirm where they actually are before acting on anything in this guide.
:::
