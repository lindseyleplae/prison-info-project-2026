...
-   **Visitor list:** The incarcerated person must submit the request. TDCJ allows up to 10 names on the visitors list.
-   **Scheduling:** Most visits are scheduled through the [TDCJ Online Visitation Portal](https://visitation.tdcj.texas.gov/).
-   **Standard in-person hours:** Saturdays and Sundays, generally 8:00 AM to 5:00 PM.
-   **Standard visit length:** Two hours.
-   **Special long-distance visit:** Up to four hours may be approved when a visitor travels 250 miles or more one way.
-   **Before travel:** Confirm the person is assigned to that unit and that visitation has not been canceled.
:::
...
:::callout{variant="tip"}
The visitor list is separate from the scheduling step. Being approved on the list does not create a visit reservation.
:::

## Scheduling a Visit

Most visits are arranged through the [TDCJ Online Visitation Portal](https://visitation.tdcj.texas.gov/). TDCJ rules require scheduling at least one day and not more than seven days before the visit.

:::steps
1. Confirm that the incarcerated person is assigned to the unit and has visitation privileges.
1. Confirm that the visitor is on the approved list.
1. Schedule through the portal, or through the warden's office or designee if the unit requires that method.
1. Recheck the unit schedule before departure.
:::
...
:::reality-check
Arrival time does not equal visit time. ID checks, searches, counts, and inmate movement affect when the two-hour period actually starts.
:::
...
Special visits are not automatic. They require advance coordination with the unit, and availability depends on space, staffing, and security conditions.
:::
...
:::callout{variant="warning"}
Do not carry a cell phone inside the secure perimeter. TDCJ prohibits phones during visitation, and providing a phone to an incarcerated person is a felony offense under Texas law.
:::
...
:::callout{variant="tip"}
Before departure, check both the [TDCJ visitation schedule](https://visitation.tdcj.texas.gov/) and the TDCJ homepage, then call the unit for final confirmation.
:::
...
TDCJ visitation rules change by custody level, unit, and operational status. Confirm the unit assignment, visitation status, schedule, and permitted items through the unit or portal before travel.
:::
