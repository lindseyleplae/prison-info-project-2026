---
title: "Medical & Mental Health in Alabama (ADOC)"
slug: medical
state: al
topic: medical
...
**There is a $4 co-pay for inmate-requested visits** — but mental-health, substance-abuse, emergency, pregnancy, chronic-care, and intake visits are exempt, and no one is denied care for inability to pay.

**A private company provides the health care** (NaphCare, the contractor as of 2026); the vendor changes, but ADOC sets the rules.

**Health information needs the inmate's written authorization,** and families have no formal medical-complaint portal.

**Alabama has no independent prison ombudsman.**
:::
...
Expect a $4 co-pay for inmate-requested visits, with broad exemptions and no denial of care for inability to pay. To raise a concern, contact the facility's Health Services Administrator or ADOC's central office, and know that clinical details require the inmate's written authorization. Because Alabama has no independent prison ombudsman, confirm the current escalation path with the facility.
:::
