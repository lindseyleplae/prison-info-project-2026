---
title: "Phone & Video Calls in CDCR"
slug: phone-video
state: ca
topic: phone-video
...
-   **Audio phone calls are free.** Since January 1, 2023, calls from institution wall phones and tablets are free to incarcerated people and their families under SB 1008, the Keep Families Connected Act.
-   **Call length:** CDCR sets a 15-minute limit per call. There is no cap on the number of free calls, other than institution-set calling hours.
-   **Provider is changing:** CDCR is transitioning from ViaPath to Securus Technologies across 2026. The active provider and the current rates depend on your facility's transition date.
-   **Video calls and messaging are paid.** Rates differ between ViaPath and Securus (see below).
-   **No incoming calls:** The incarcerated person initiates every call. You cannot call into a prison.
:::
...
:::steps
1. The incarcerated person adds your phone number to their approved contact or phone list through facility procedures.
1. Facility staff review and approve the contact list. This can take time after intake or a transfer.
1. Once your number is active on their list, the incarcerated person can call you during institution calling hours.
1. Keep your number current. A change of number or a transfer can require the number to be re-added at the facility.
:::
...
Because the provider changes facility by facility during 2026, confirm which vendor currently serves your facility before paying for video or messaging. CDCR's Tablets and Telephones page lists each institution's transition dates.
:::
...
:::reality-check
The per-minute video figures above are CDCR's posted rates. You are billed for the actual length of a video visit, so a scheduled slot that ends early is charged only for the time used.
:::
...
For the in-person side of visiting — approval, scheduling, and dress code — see [Visiting in California](/states/california/guides/visiting/).

## Verify Before Acting

:::callout{variant="warning" title="Verify Before Acting"}
California is actively switching from ViaPath to Securus during 2026, and rates, tablet rules, and video availability change as each facility transitions. Audio calls are free under both vendors, but confirm the current provider, video rate, and messaging cost for your specific facility on CDCR's Tablets and Telephones page before adding money or scheduling a paid visit.
:::
