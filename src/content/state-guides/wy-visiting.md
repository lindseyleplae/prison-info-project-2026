---
title: "Visiting in Wyoming (WDOC)"
slug: visiting
state: wy
topic: visiting
relatedNationalGuide: visiting-basics
system: WDOC
description: "How visitor approval works in Wyoming — the inmate starts the application — plus the dress code, the 20-visitor list limit, and what to expect at the door."
sources:
...
**The incarcerated person starts the process** — they mail the application forms to the people they want on their list.

**The decision goes to them too:** the facility notifies the inmate in writing within 30 days; the inmate tells the visitor.

**Scheduling:** Mostly first come, first served on posted facility schedules — arrive within 15 minutes of the session start.

**List limit:** 20 active adult visitors per person; children under 18 don't count against it.
:::
...
Wyoming's visiting schedules are posted facility by facility and change without a fixed pattern, and some posted schedules are older than others. Confirm the current schedule for the specific facility on WDOC's visitation page, confirm the application was approved through the incarcerated person before traveling, and check the facility's own clothing restrictions — they add to the statewide rules.
:::
