...
abbreviation: VA
system: VADOC
systemFullName: "Virginia Department of Corrections (VADOC)"
summary: "Guides and facility information for Virginia, where the Department of Corrections runs about three dozen adult prisons — but many people serving a state sentence are held in local and regional jails, which set their own rules."
hotlines:
